export const WEAPON_PROFICIENCY_RULE_SOURCE = Object.freeze({
...
export const WEAPON_PROFICIENCY_PROGRESSION = Object.freeze({
...
export function getWeaponProficiencySlots(classId, level) {
...
export function getNonproficiencyPenalty(classId) {
