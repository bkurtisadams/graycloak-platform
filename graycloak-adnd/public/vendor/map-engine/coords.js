...
import { HEX_R, SUB_R, SQRT3, ANCHOR_COL, ANCHOR_ROW, NEIGHBOR_DELTAS, } from './constants.js';
/**
 ...
 */
export function parentSvgCenter(col, row) {
    return {
...
export const ANCHOR_SVG = parentSvgCenter(ANCHOR_COL, ANCHOR_ROW);
/**
 ...
 */
export function parentCenterAxial(col, row) {
 ...
 * the y axis.
 */
export function subhexSvgCenter(Q, R) {
    return {
 ...
 */
export function svgToAxial(x, y) {
