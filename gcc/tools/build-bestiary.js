...
function parseCreature(b) {
  ...
  const entry = {
    ...
    abilities:  field(b.body, 'Abilities') || looseField(/^\*\*[^*]*\babilities:\*\*\s*(.+)$/mi),
...
const header = `// gw-mp-bestiary.js v0.2.0 — GENERATED by tools/build-bestiary.js. Do not hand-edit.
