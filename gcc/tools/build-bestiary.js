...
const header = `// gw-mp-bestiary.js v0.2.3 — GENERATED by tools/build-bestiary.js. Do not hand-edit.
...
const out = header + '(function(){\n  "use strict";\n  window.GWBestiary = ' +
  ...
  ';\n  try { console.log("[gw-mp-bestiary] v0.2.3 loaded ("+Object.keys(window.GWBestiary).length+" creatures)"); } catch(_){}\n})();\n';
