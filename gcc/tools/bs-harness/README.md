...
(jsdom does not compute user-select). Everything else should pass; baseline 1081 ok at v0.61.9 (1019 at v0.61.6.4, 1017 at v0.61.6.3, 1008 at v0.61.6.2, 1004 at v0.61.6.1, 1003 at v0.61.6, 996 at v0.61.5.4, 954 at v0.61.2.1). `node run.mjs .` from the repo root works — the root is path.resolve()d.
