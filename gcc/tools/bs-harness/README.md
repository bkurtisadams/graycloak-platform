...
(jsdom does not compute user-select). Everything else should pass; baseline 996 ok at v0.61.5.3 (954 at v0.61.2.1). `node run.mjs .` from the repo root works — the root is path.resolve()d.
