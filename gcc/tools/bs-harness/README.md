...
(jsdom does not compute user-select). Everything else should pass; baseline 974 ok at v0.61.3.5 (954 at v0.61.2.1). `node run.mjs .` from the repo root works — the root is path.resolve()d.
