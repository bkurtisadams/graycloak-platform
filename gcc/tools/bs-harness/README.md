...
(jsdom does not compute user-select). Everything else should pass; baseline 988 ok at v0.61.4.5 (954 at v0.61.2.1). `node run.mjs .` from the repo root works — the root is path.resolve()d.
