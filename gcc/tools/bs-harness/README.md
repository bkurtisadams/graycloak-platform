...
(jsdom does not compute user-select). Everything else should pass; baseline 1003 ok at v0.61.6 (996 at v0.61.5.4, 954 at v0.61.2.1). `node run.mjs .` from the repo root works — the root is path.resolve()d.
