// gw-mp-bestiary.js v0.2.3 — GENERATED by tools/build-bestiary.js. Do not hand-edit.
...
(function(){
  ...
  window.GWBestiary = {
    ...
    "Cal Then": {
      ...
      "weaknesses": "- Compulsion (gourmand for bones, distractible by fresh bones; final -5 CP)",
      "equipment": null,
      "forms": [
        {
          "bc": {
    ...
    "Keeshin": {
      ...
      "origin": "Mutated or Evolved",
      "cpEstimate": "178",
      "abilities": "Flight (Telekinetic, moderate speed; final 10 CP); Telekinesis A (final 7.5 CP — also lifts/manipulates stone for dwelling-building); Stretching Abilities A Telekinetic Arm (final 10 CP); Force Field A Personal (final 17.5 CP); Siphon Hits Life Leech (final 12.5 CP); Transmutation Comprehensive De-evolution (final 25 CP); Mental Ability A Mental Blast (final 17.5 CP; use GW-derived MS 16 attack/defense mapping, not MP IN); Ice Abilities B Cryokinesis Blast (final 12.5 CP); Reflection (one type, e.g., energy; final 12.5 CP)",
    ...
    "Robotic Unit": {
      ...
      "origin": null,
      "cpEstimate": null,
      "abilities": "Adaptation Bio (5 CP), Adaptation Mental (10 CP for non-borg / 5 CP partial for borg), Heightened Defense Mental (5 CP).",
      "weaknesses": null,
      "equipment": null,
      "forms": [
        {
    ...
    "Serf": {
      ...
      "origin": "Mutated or Evolved",
      "cpEstimate": "191",
      "abilities": "Natural Weaponry — poison claws +d4 sharp (final 5 CP); Poison/Venom A — claws contact intensity 8 (final 5 CP); Light Wave: Visible-Light Invisibility, self only (final 7.5 CP); Light Wave: Darkness Control, 2m radius within 10m (final 5 CP); Light Wave: Negation, laser attacks only (final 5 CP); Density Control (others) — Gravity Control A or Transmutation 30m (final 20 CP); Life Leech — Siphon Hits Area 10m radius 6 HP/turn (final 15 CP); Death Field Generation — Death Touch + Area 20m (final 35 CP); Mental Blast — Mental Ability A (final 17.5 CP; use GW-derived MS 15 attack/defense mapping, not MP IN); Telepathy (final 10 CP); Armor 6 = 4/1/0/1 (final 10 CP — partial carapace)",
      "weaknesses": "None.",
