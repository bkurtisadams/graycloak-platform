...
| drive repair | seat:engineer | 1982 "more complete repairs": class A–C (Book 3 starport table), priced by Book 2 p.18 Repair Parts — 2D × 10% of each failed drive's cost, quoted once per port call. A failed Free Trader jump drive is Cr2–12M: a ship with no engineer to patch in flight can be stranded by it |
