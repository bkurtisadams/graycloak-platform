...
| 6 | person encounters + law harassment | first slice (rules 0.75.0, client v0.318.0): Book 3 pp.19-21 person encounters once a day on the surface, the p.7 arrest throw for police meeting a party carrying what the law forbids; groups go on the board as statblocks. An arrest for a weapons violation is 1D days in jail (The Traveller Book, 1982; client v0.318.1): the party leaves the surface and the days pass on both clocks. Open: terms for other offences, confiscation, customs at the starport edge, patrons |
