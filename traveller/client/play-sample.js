...
export const SAMPLE_SITUATIONS = Object.freeze({
  ...
  fight: {
    ...
    situation: { kind: 'fight', title: 'Fight, round 3', detail: 'Range bands' },
    // Bands are Book 1 p.29 (1977). Thug 1 is in the next band to Hawkeye:
    // short range, one move from close.
    ...
    fighters: [
      ...
      { id: 'reyne', name: 'Dockmaster Reyne', side: 'party', band: 1,
        ...
        order: null },
      { id: 'thug-1', name: 'Thug 1', side: 'foe', band: 3,
