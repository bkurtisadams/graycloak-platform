...
import { h, renderTalkLog, bandsScene, subsectorScene, shipFightScene } from './play-views.js?v=v0.303.0';
import { renderSheets, forgetSheetPosition } from './sheets.js?v=v0.303.0';
import { initAuth, currentUserId, onAuthChange, authStatus } from './auth.js?v=v0.303.0';
import { ensureFirestore, watchChat, sendChatMessage, watchDeclarations, writeDeclaration, writeWoundAllocation, touchSeat, loadCharacterRecord, saveCharacterRecord, watchOwnCharacterRecords, writeJoinRequest } from './publish.js?v=v0.303.0';
...
import { interpretChatInput, createChatMessage, rollFormula, formatRoll } from '../src/dice-tray.js?v=v0.303.0';
import { playerSheetViews, formatCampaignDate } from '../src/play-session.js?v=v0.303.0';
import { importCharacterDocument, skillGuide, skillDM, PERSONAL_WEAPONS } from '../vendor/classic-traveller-rules/index.js?v=v0.303.0';
