...
import {
  ...
  writeCanvasPresence, watchCanvasPresence, sendChatMessage, watchChat } from './publish.js?v=v0.165.0';
import { createPlayerDeclaration } from '../src/player-declaration.js?v=v0.165.0';
import { createPlayerTokenMove } from '../src/player-token-movement.js?v=v0.165.0';
import { serviceName, nobleTitleLabel, buildServiceHistory, buildGenerationLog } from './ui-model.js?v=v0.165.0';
import { PERSONAL_WEAPONS, SUBSECTOR_COLUMNS, SUBSECTOR_ROWS, getSubsectorSystem } from '../vendor/classic-traveller-rules/index.js?v=v0.165.0';
import { renderSubsectorMap } from './subsector-svg.js?v=v0.165.0';
import { createSceneCanvas, svgNode } from './scene-canvas.js?v=v0.165.0';
...
import { FAR_MERIDIAN_SUBSECTOR } from '../world/far-meridian-subsector.js?v=v0.165.0';
