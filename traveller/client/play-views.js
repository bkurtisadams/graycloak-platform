...
import { renderSubsectorMap, createSvgNode, SUBSECTOR_SVG_GEOMETRY, subsectorHexCenter } from './subsector-svg.js?v=v0.326.2';
import { renderReactionPanel } from './reaction-panel.js?v=v0.326.2';
import { FAR_MERIDIAN_SUBSECTOR } from '../world/far-meridian-subsector.js?v=v0.326.2';
import { rangeBandForBandGap, ENCOUNTER_RANGE_LINE_ESCAPE_BANDS } from '../src/encounter-document.js?v=v0.326.2';
import {
...
import { renderVectorFight, renderPhaseTrack, renderDataCards } from './vector-fight-view.js?v=v0.326.2';
import { kindButton, kindIcon } from './kind-button.js?v=v0.326.2';
import { renderSectionStrip } from './section-strip.js?v=v0.326.2';
export { renderSectionStrip };
import { actorBadge, shipBadge } from './sheets.js?v=v0.326.2';
import { woundPromptFrom, initialWoundDraft, previewWoundDraft, renderWoundGroups, renderWoundPreview } from './wound-dialog.js?v=v0.326.2';
...
import { renderVectorSceneStage } from './ship-vector-map.js?v=v0.326.2';
...
function patronsPanel(p, handlers) {
  ...
  for (const task of p.tasks ?? []) {
    parts.push(h('section', { class: 'patron-card is-task', 'aria-label': 'A job to carry out' },
      ...
      task.command ? h('div', { class: 'lead-actions' }, kindButton({ label: 'Carry it out', kind: 'money', primary: true }, { onclick: () => people(task.command) })) : null));
  }
  if (p.patron) {
