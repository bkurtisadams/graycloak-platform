...
import { ENCOUNTER_DOCUMENT_TYPE, importEncounterDocument } from '../src/encounter-document.js?v=v0.163.0';
import { NPC_ACTOR_DOCUMENT_TYPE, importNpcActorDocument } from '../src/npc-actor-document.js?v=v0.163.0';
import { MEDIA_ASSET_DOCUMENT_TYPE, importMediaAssetDocument } from '../src/media-asset-document.js?v=v0.163.0';
import { ACTIVITY_LOG_DOCUMENT_TYPE, importActivityLogDocument } from '../src/activity-log-document.js?v=v0.163.0';
